                                ...
                                <div class="col-lg-5">
                                    <div class="input-group ps-3 pt-7">
                                        <span class="input-group-btn">
                                            <button wire:click.prevent='decrease({{ $carts[$i]->id }})' type="button" class="quantity-left-minus btn btn-quantity btn-danger btn-number"  data-type="minus" data-field="">
                                        ...
                                        <span class="input-group-btn">
                                            <button wire:click.prevent="increase({{ $carts[$i]->id }})" type="button" class="quantity-right-plus btn btn-quantity btn-success btn-number" data-type="plus" data-field="">
