            ...
            @else
                ...
                @if (sizeof($carts) != 0)
                    <div class="row justify-content-center mt-5">
                        <a style="text-decoration: none; width: auto;" href="/checkout">
                            <button type="button" class="btn btn-checkout btn-success rounded-pill pt-2 pb-2 ps-5 pe-5" style="display: flex; width: auto; justify-content: center;">Checkout
