                        ...
                        <form method="POST" action="/login">
                            ...
                            <div class="row pb-3" style="padding: 0rem 1rem">
                                <div class="col-6 col-md-6" style="padding-left: 0.1rem">
                                    <input class="orange checklist"name="remember" type="checkbox" value="lsRememberMe" id="rememberMe"> 
                            ...
                            <div class="row pb-3" style="padding: 0rem 1rem">
                                <p class = "orange" style="padding: 0rem 0rem">Don't have an account? <a class = "orange link-hover-register" href="/register"> Register Here</a>.</p>
                            </div>
                        </form>
                    </div>
                </div>
